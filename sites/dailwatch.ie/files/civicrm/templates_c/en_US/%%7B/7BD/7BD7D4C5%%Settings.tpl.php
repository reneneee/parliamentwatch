<?php /* Smarty version 2.6.26, created on 2012-12-24 12:32:24
         compiled from CRM/Contribute/Form/ContributionPage/Settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 29, false),array('function', 'help', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 41, false),array('function', 'crmURL', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 55, false),)), $this); ?>
...
<div id="help">
    ...
    <?php else: ?>
        <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Use this form to edit the page title, contribution type (e.g. donation, campaign contribution, etc.), goal amount, introduction, and status (active/inactive) for this online contribution page.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
    <?php endif; ?>
</div>
...
<br/>
	...
	<tr class="crm-contribution-contributionpage-settings-form-block-contribution_type_id"><td class="label"><?php echo $this->_tpl_vars['form']['contribution_type_id']['label']; ?>
</td><td><?php echo $this->_tpl_vars['form']['contribution_type_id']['html']; ?>
<br />	
            <span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Select the corresponding contribution type for contributions made using this page.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span> <?php echo smarty_function_help(array('id' => "id-contribution_type"), $this);?>
</td>
	</tr>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('profileURL', ob_get_contents());ob_end_clean(); ?>
                    ...
                    <?php else: ?>
                      <?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['profileURL'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>To change the organization data collected use the "On Behalf Of Organization" profile (<a href="%1">Administer > Customize > CiviCRM Profile</a>).<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
                    <?php endif; ?>
                </td>
            </tr>
            <?php if (! $this->_tpl_vars['invalidProfiles']): ?>
...
<br />
    		<span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>When enabled, links will appear allowing people to share this event through social media.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span></td>
    	</tr>
